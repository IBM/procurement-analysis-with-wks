...
(function() {
  ...
  syncservice.syncService = function(callback) {
    ...
    discovery.query({
      ...
      query:
        'enriched_text.relations.arguments.entities.type:Facility_Production_Down,enriched_text.relations.arguments.entities.type:Price,enriched_text.relations.arguments.entities.type:Time_Period&return=enriched_text.relations'
    },
